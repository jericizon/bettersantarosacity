...
<template>
  <div class="inline-flex items-center gap-1.5 text-xs text-charcoal/80 bg-parchment px-2 py-1 rounded border border-charcoal/10">
    ...
    <a
      ...
      class="text-rose-accent hover:underline inline-flex items-center ml-0.5 rounded-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-laguna-green"
